...
This vignette demonstrates how to use the `CudaMon` package to monitor a NVIDIA GPU during performing high-performance matrix multiplication on NVIDIA GPUs using CUDA.
